    ...
    <>
      ...
      <div className="lg:w-[75%]">
        ...
        {newsData.map((article, index) => (
          ...
          <div key={index} className="bg-[#F9FFFF] hover:border-indigo-200 hover:border-inset hover:border m-2 rounded-xl p-5 cursor-pointer">
            <div className="flex gap-4 items-start">
              ...
              <div className="w-full px-2">
                ...
                <div className="text-xs">
                  <p>Article By <a className="font-bold">{article.author}</a>, {article.publishedAt}</p>
                </div>
              </div>
            </div>
          </div>
